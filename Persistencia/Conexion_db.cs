    ...
    public class Conexion_db
    {
        ...
        protected MySqlConnection GetConexion()
        {
            ...
            catch
            {
                ...
                MessageBox.Show("Parece que ocurrió un error al conectarnos a la base de datos, por favor inténtalo más tarde.", "Error 500:", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return null;
            }
